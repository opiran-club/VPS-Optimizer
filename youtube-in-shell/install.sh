...
update()
{
  ...
  repositoryName="VPS-Optimizer" #Name of repostiory to be updated ex. Sandman-Lite
  githubUserName="OPIran-CluB" #username that hosts the repostiory ex. alexanderepstein
